            ...
            <Card key={member.name} className="team-card">
              <CardContent className="flex flex-col items-center p-6">
                ...
                <div className="mt-2 flex space-x-2">
                  <a href={`https://github.com/${member.github}`} className="text-gray-400 hover:text-[#8e44ad]">
                    <Github className="h-5 w-5" />
                  </a>
                  <a href={`https://linkedin.com/in/${member.linkedin}`} className="text-gray-400 hover:text-[#8e44ad]">
