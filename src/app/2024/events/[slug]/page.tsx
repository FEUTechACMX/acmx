    ...
    return (
        <div className="relative mb-[8rem]"> 
            ...
            <section className="fixed lg:hidden z-50 bottom-0 p-2 w-full">
                <div className="bg-[#F9F9F9] px-5 py-4 rounded-2xl shadow-[0_0_20px_0_rgba(0,0,0,0.4)]">
                    <div className="flex justify-between items-end">
                        <h1 className="font-bold text-[#6A086A] text-2xl"> ₱ 150.00 / Free </h1>
                        <p className="font-light text-[#474747] text-md"> 14 tickets left </p>
                    </div>
                    <div className="mt-2 bg-black inline-block rounded-md w-full">
                        <Button className="text-md font-bold h-[3rem] w-full bg-gradient-to-r from-[#A330B0] via-[#58138D] to-[#3D017D] hover:opacity-80 transition-all duration-150"> Register now </Button>
                    </div>
                </div>
            </section>
            <section className="relative flex justify-center mx-10">
                <main className="relative flex gap-10 -top-6">
                    <section className="relative max-w-[50rem]">
                        <section>
                            <h1 className="font-black text-4xl md:text-5xl inline-block text-transparent bg-clip-text bg-gradient-to-r from-[#A330B0] via-[#58138D] to-[#3D017D]"> Headline </h1>
                        ...
                        <section className="lg:hidden mt-4">
                            <div className="bg-[#F9F9F9] p-9 rounded-xl shadow-xl">
